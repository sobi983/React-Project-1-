...
//this file is for the practice purpose, however in the real word we will create a backend for this purpose
createServer({
    models: {
        vans: Model,
        users: Model
    ...
    seeds(server) {
        ...
        server.create("user", { id: "123", email: "sohaib.shaikh98@gmail.com", password: "123", name: "Bob" })
    },
